...
create table negozio.prodotto(
	...
	vetrina int references negozio.vetrina(codiceV) on delete cascade on update cascade not null,
	prodotto int references negozio.prodotto(codiceP) on delete restrict on update cascade not null,
